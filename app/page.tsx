...
export default function Page() {
  ...
  const [biMortgage, setBiMortgage] = useState(0);
  const [biMortRate, setBiMortRate] = useState(3.5);
  const [biPersonal, setBiPersonal] = useState(0);
  const [biPersRate, setBiPersRate] = useState(9.0);
  const [biHome, setBiHome] = useState(0);
      ...
      <div className="mx-auto max-w-[1280px] p-4 sm:p-6">
        {tab === "bakain" ? (
          <div className="grid lg:grid-cols-2 gap-4 max-w-4xl">
            <div className="border border-[#27272A] bg-[#18181B] p-5 space-y-4">
            ...
            <div className="border border-[#27272A] bg-[#18181B] p-5 space-y-3">
          ...
          <div className="space-y-4">
            ...
            {!loans.length ? (
              <div className="border border-dashed border-[#27272A] p-10 text-center text-[#71717A] text-[13px]">Lägg till lån eller ladda exempel först.</div>
            ) : (
              <div className="grid sm:grid-cols-3 gap-3">
                {[{ t: "Idag", r: resultCustom }, { t: "Lavin", r: resultAva }, { t: "Snöboll", r: resultSnow }].map((c) => (
                  <div key={c.t} className="border border-[#27272A] bg-[#18181B] p-5">
          ...
          <div className="grid lg:grid-cols-[1fr_380px] gap-4">
            <div className="space-y-3">
              {loans.length === 0 && (
                <div className="border border-dashed border-[#27272A] bg-[#18181B] p-10 text-center">
                  ...
                  <div className="flex gap-2 justify-center flex-wrap">
                    ...
                    <button onClick={loadExample} className="h-9 px-4 border border-[#27272A] bg-[#09090B] text-[12px] text-[#A1A1AA] hover:text-[#FAFAFA]">Ladda exempel</button>
                  </div>
                </div>
              )}
              ...
              {loans.map((loan) => {
                ...
                return (
                  <div key={loan.id} className="border border-[#27272A] bg-[#18181B]">
              ...
              {loans.length > 0 && (
                <div className="border border-[#27272A] bg-[#18181B] p-3 space-y-2">
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <div className="mt-5 grid grid-cols-[96px_1fr] items-center gap-6">
                      <div className="relative h-[96px] w-[96px]">
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center">
                          <span className="mono text-[16px] font-semibold leading-none">{fmt(totalInterest)}</span>
                          <span className="mono text-[10px] text-[#71717A]">/mo ränta</span>
                        </div>
                      </div>
                      <div className="space-y-3">
                        <div className="flex items-center justify-between">
